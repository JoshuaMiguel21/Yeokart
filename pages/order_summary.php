...
<body style="margin: 30px;">
    ...
    <div class="left">
        <div class="reminders-container">
            ...
            <ul>
                <li><span class="larger-font">Metro Manila - <strong>₱ 100</strong></span></li>
                <li><span class="larger-font">Provinces - <strong>₱ 180</strong></span></li>
            </ul>
            <p>Large Items (More than 3 albums)</p>
            <ul>
                <li><span class="larger-font">Metro Manila - <strong>₱ 120</strong></span></li>
                <li><span class="larger-font">Provinces - <strong>₱ 220</strong></span></li>
            </ul>
